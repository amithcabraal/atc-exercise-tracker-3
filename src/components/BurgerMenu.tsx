      ...
      >
        <div className="p-4">
          ...
          <nav className="mt-8 space-y-2">
            <MenuItem icon={List} text="Choose Session" href="/sessions" />
            <MenuItem icon={Settings} text="Session Admin" href="/admin/sessions" />
            <MenuItem icon={Book} text="Exercise Journal" href="/journal" />
            <MenuItem icon={Settings} text="Exercise Admin" href="/admin/exercises" />
            <MenuItem icon={RotateCcw} text="Reset App" href="/reset" />
